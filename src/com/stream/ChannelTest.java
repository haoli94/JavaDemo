...
//    new ChannelTest().test0();
  ...
  private void test4() throws IOException {
    ...
    //4、聚集写入
    RandomAccessFile outRandomAccessFile = new RandomAccessFile("hello5.txt", "rw");
  ...
  private void test3() {
    ...
    try {
      //1、创建通道
      inChannel = FileChannel.open(Paths.get("hello1.txt"), StandardOpenOption.READ);
      outChannel = FileChannel.open(Paths.get("hello4.txt"), StandardOpenOption.READ, StandardOpenOption.WRITE, StandardOpenOption.CREATE);
  ...
  private void test2() {
    ...
    try {
      //1、创建通道
      inChannel = FileChannel.open(Paths.get("hello1.txt"), StandardOpenOption.READ);
      outChannel = FileChannel.open(Paths.get("hello3.txt"), StandardOpenOption.READ, StandardOpenOption.WRITE, StandardOpenOption.CREATE);
  ...
  public void test0() {
    ...
    System.out.println(file.toString() + " created " + b);
  }
  ...
  public void test1() {
    ...
    File source = null;
    try {
      source = new File("hello1.txt");
      String target = "hello2.txt";
