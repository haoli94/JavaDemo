...
//      }
  ...
  public void server() {
    ...
    try {
      ...
      outChannel = FileChannel.open(Paths.get("helloss.txt"), StandardOpenOption.READ, StandardOpenOption.WRITE, StandardOpenOption.CREATE);
      ...
      // outChannel.transferFrom(acceptSocketChannel,0 ,1024); 不知道写过来的数据大小, 最好还是用 while 读取
